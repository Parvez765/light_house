...
const Hero = () => {
  ...
  return (
    <section className="container mx-auto">
      {/* Whole Container */}
      <div className="lg:mt-[50px] mb-[80px] p-[20px] grid lg:grid-cols-2 gap-[20px] items-center mx-4">
        <div>
          ...
          <p className="mt-[8px] font-medium text-[#667085] text-[14px]">No Credit Card Required</p>
        </div>
        <div>
