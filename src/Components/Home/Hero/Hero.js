...
const Hero = () => {
  ...
  return (
    <section className="container mx-auto">
      {/* Whole Container */}
      <div className="mt-[50px] mb-[80px] grid lg:grid-cols-2 gap-[20px] items-center">
        <div>
          <h1 className="md:text-[80px] font-bold leading-[80px]">We Make <span className="text-sky-600">Retouching</span> Easy</h1>
          ...
          <p className="mt-[8px] text-[#667085] text-[14px]">No Credit Card Required</p>
        </div>
        <div>
