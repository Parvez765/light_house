...
const BestTeams = () => {
    ...
    return (
        <div>
            ...
            <p className='mt-[12px]  px-5 lg:px-0 text-center font-medium text-[22px] text-gray-600'>Find The Best Team From Us Who Will Be Ready To Get The Job Done</p>
            ...
            <Swiper
                ...
                >
               {
                    teams?.map(t => <div>
                        <SwiperSlide>
                          <div className={`lg:w-[450px] lg:h-[600px] block mx-auto ${styles.cardContainer}`}>
                            <img src={t.img} alt="Light House Team" className='w-full h-[350px] object-cover'/>
                             ...
                             <FaStar className='text-yellow-400 text-[20px]'/>
                              ...
                              <div>
                               ...
                               <h2 className='text-[30px] font-bold'>{t.name}</h2>
                                <p className='text-[26px] lg:text-[20px] font-medium'>{t.designation}</p>
